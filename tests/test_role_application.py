...
class TestRoleApplication(unittest.TestCase):
    ...
    def test_create_Role_Application(self):
        ...
        assert Role_Application1.create_role_application() == True
    ...
    def test_create_Role_Application_reject_no_active_role_listing(self):
        ...
        assert Role_Application2.create_role_application() == "Error: Role Listing ID does not exist or is closed."

    def test_create_Role_Application_reject_no_staff_ID(self):
        Role_Application3 = Role_Application(1,8)
        assert Role_Application3.create_role_application() == "Error: Staff ID does not exist."

    def test_create_Role_Application_reject_duplicate(self):
        Role_Application4 = Role_Application(1,1)
        assert Role_Application4.create_role_application() == True
        Role_Application5 = Role_Application(1,1)
        assert Role_Application5.create_role_application() == "Error: Role Application already exists."
