...
class TestRoleListing(unittest.TestCase):
    ...
    def test_create_Role_Listing(self):
        ...
        assert Role_Listing1.create_Role_Listing() == True
    ...
    def test_create_Role_Listing_reject_past_date(self):
        Role_Listing1 = Role_Listing(10, "IT Team", "2020-12-10", "IT Team description is here")
        assert Role_Listing1.create_Role_Listing() == False

    # boundary test case -> date is today
    def test_create_Role_Listing_reject_today_date(self):
        today_date_str = date.today().strftime("%Y-%m-%d")
        Role_Listing2 = Role_Listing(10, "IT Team", today_date_str, "IT Team description is here")
        assert Role_Listing2.create_Role_Listing() == False
    ...
    def test_create_Role_Listing_reject_duplicate_primary_key(self):
        Role_Listing1 = Role_Listing(1, "IT Team", "2023-12-10", "IT Team description is here")
        assert Role_Listing1.create_Role_Listing() == False

    # negative test case -> assert False for any empty Strings
    def test_create_Role_Listing_empty_Role_Listing_ID(self):
        Role_Listing1 = Role_Listing("", "IT Team", "2023-12-10", "IT Team description is here")
        assert Role_Listing1.create_Role_Listing() == False

    def test_create_Role_Listing_empty_Role_Name(self):
        Role_Listing1 = Role_Listing(10, "", "2023-12-10", "IT Team description is here")
        assert Role_Listing1.create_Role_Listing() == False

    def test_create_Role_Listing_empty_Date_Closed(self):
        Role_Listing1 = Role_Listing(10, "IT Team", "", "IT Team description is here")
        assert Role_Listing1.create_Role_Listing() == False

    def test_create_Role_Listing_empty_Role_Description(self):
        Role_Listing1 = Role_Listing(10, "IT Team", "2023-12-10", "")
        assert Role_Listing1.create_Role_Listing() == False

    # negative test case -> assert False for any Null values
    def test_create_Role_Listing_null_Role_Listing_ID(self):
        Role_Listing1 = Role_Listing(None, "IT Team", "2023-12-10", "IT Team description is here")
        assert Role_Listing1.create_Role_Listing() == False

    def test_create_Role_Listing_null_Role_Name(self):
        Role_Listing1 = Role_Listing(10, None, "2023-12-10", "IT Team description is here")
        assert Role_Listing1.create_Role_Listing() == False

    def test_create_Role_Listing_null_Date_Closed(self):
        Role_Listing1 = Role_Listing(10, "IT Team", None, "IT Team description is here")
        assert Role_Listing1.create_Role_Listing() == False

    def test_create_Role_Listing_null_Role_Description(self):
        Role_Listing1 = Role_Listing(10, "IT Team", "2023-12-10", None)
        assert Role_Listing1.create_Role_Listing() == False
